...
})({"7SYgK":[function(require,module,exports) {
...
function MyComponent(props) {
    return (()=>{
        ...
        (0, _web.insert)(_el$, ()=>props.name, null);
        return _el$;
    })();
}
console.log("Hello", (0, _web.createComponent)(MyComponent, {
    name: "Solid"
}), (0, _solidJs.createSignal));

},{"solid-js/web":"g4OyJ","solid-js":"hiOgk"}],"g4OyJ":[function(require,module,exports) {
...
function getNextElement(template) {
    let node, key;
    if (!(0, _solidJs.sharedConfig).context || !(node = (0, _solidJs.sharedConfig).registry.get(key = getHydrationKey()))) return template.cloneNode(true);
...
},{"solid-js":"hiOgk","@parcel/transformer-js/src/esmodule-helpers.js":"gmoFh"}],"hiOgk":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
function readSignal() {
    ...
    if (this.sources && (!runningTransition && this.state || runningTransition && this.tState)) {
        if (!runningTransition && this.state === STALE || runningTransition && this.tState === STALE) updateComputation(this);
        else {
...
function mergeProps(...sources) {
    if (sources.some((s)=>s && ($PROXY in s || typeof s === "function"))) return new Proxy({
        get (property) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gmoFh"}],"gmoFh":[function(require,module,exports) {
...
},{}]},["7SYgK","4aBH6"], "4aBH6", "parcelRequiree8ef")
